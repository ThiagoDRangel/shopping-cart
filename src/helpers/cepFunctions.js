...
export const searchCep = async () => {
  const selectedAddress = document.querySelector('.cart_address');
  ...
  promises.any(promises).then((value) => value.json())
